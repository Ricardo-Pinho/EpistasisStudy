...
int calculate_test_scores(Data_map & data_map,
    ...
    int ind=0;    
    double real_chi1=g_test(a2_y[ind],a3_y[ind],abcdef[0][ind],abcdef[2][ind],s,p,g);
    double real_chi2=g_test(b2_y[ind],b3_y[ind],abcdef[1][ind],abcdef[3][ind],t,q,h);
    double real_chi3=g_test(e2_y[ind],e3_y[ind],abcdef[4][ind],abcdef[5][ind],r,o,l);
